...
card_graph = dbc.Card(
        dcc.Graph(id='scrnaseq_line_plot', figure={}), body=True, color="secondary",
)

layout = html.Div([
    dbc.Row(dbc.Col(card_graph, width=8), justify="center"),  # justify="start", "center", "end", "between", "around"
])
...
#             if i == "study_id" or i == "site" or i == "id"
